    ...
    <section id="home" className="lg:py-16 mb-5 lg:px-8">
      <div className="grid grid-cols-1 sm:grid-cols-12 gap-1">
        ...
        <motion.div
          ...
          className="col-span-12 sm:col-span-4 place-self-center mt-8 sm:mt-0 order-first sm:order-last mb-8 md:mb-0"
        >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-auto sm:w-auto justify-center sm:justify-start">
            <AnchorLink
              href="#contact"
              offset="50"
              className="px-4 md:px-5 py-3 rounded-full bg-gradient-to-br from-primary-500 to-secondary-500 hover:opacity-90 text-white text-center w-fit sm:w-fit transition"
            >
              Connect With Me
            </AnchorLink>
            <a
              ...
              className="px-1 py-1 w-fit sm:w-fit rounded-full bg-gradient-to-br from-primary-500 to-secondary-500 hover:opacity-90 text-white"
            >
